...
from . import views
from .views import search,MyOrderView,notifications,order_successful,Orderview,UserRegisterView,UserEditView,ProfileView,profile_upload,AddCatagoryView,HomeView,UpdatePostView,CatagoryView,DeletePostView,ArticleDetailView,AddPostView
